...
// Este ejercicio corresponde a utilizacion de Variables en PHP
   ...
   echo "<html><head> <meta charset=\"utf-8\"></head>";
    ...
    echo "<h2> Esta eotra fila de la cclase:"  .$NombreClase "con dos cadenas cotatenadas</h2>";
    echo "</body>";
    echo "</html>";
    $numero =50;
    $calculo = $numero /2 +6;
    ...
    $logico =true;
    $logico2 false;
    echo "<p> El cntenido de una variable tipo booleana verdadera: $logico y vatiable booleana falsa: $logico2</p>";
